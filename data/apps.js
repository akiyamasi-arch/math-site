...
const APP_DATA = [
  ...
  },
  {
    ...
    unit: "数と式",
    order: 80,
    title: "数学ダンジョン（3Dで歩いて復習）",
    description: "地下5階のダンジョンを歩き回り、かくれている「数の結晶」にふれると問題が出ます。まちがえても、解く人が実際に考える順に解説が1段階ずつ開き、何度でも挑戦できます。B1Fは数と式、下の階は2次関数・三角比・場合の数と確率・指数対数と数列に進みます。",
    file: "apps/math-dungeon.html",
    added: "2026-09-24"
  },
  {
    subject: "数学Ⅰ",
  ...
  },
  {
    ...
    order: 10,
    title: "どこに集合する？",
    description: "Aさん・Bさん・Cさんの3人が待ち合わせをします。3人にとって公平な集合場所はどこでしょう。地図をタップすると、そこから3人の家までの距離が出ます。何度でも場所を動かしてさがしてください。町を変えたり、家そのものを動かしたりもできます。",
    file: "apps/meeting-point-search.html",
    added: "2026-09-15"
  },
  {
    subject: "数学A",
